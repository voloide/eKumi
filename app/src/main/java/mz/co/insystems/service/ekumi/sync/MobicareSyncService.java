...
public class MobicareSyncService {
    ...
    public static final String URI_AUTHORITY    = "www.insystems-ekumi.net";
    ...
    public static final String SERVICE_CHECK_MOBILE_NUMBER_AVAILABILITY = "isMobileNumberAvailable";
    ...
    public static final String SERVICE_RESET_PIN = "resetPin";
    ...
    public Uri.Builder initServiceUri(){
        ...
        uri.appendPath("api");
        uri.appendPath("ekumi");
        uri.appendPath(API_VERSION);
