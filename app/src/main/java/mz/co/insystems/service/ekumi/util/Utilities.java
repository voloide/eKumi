package mz.co.insystems.service.ekumi.util;
...
public class Utilities implements Serializable {
    ...
    public <T extends AbstractBaseVO> T fromJsonObject(JSONObject response, Class clazz) throws IOException {
        return (T) objectMapper.readValue(String.valueOf(response), clazz);
    }

    public JSONObject toJsonObject(AbstractBaseVO registo) throws JsonProcessingException, JSONException {
        JSONObject jsonObject = new JSONObject(objectMapper.writeValueAsString(registo));
        return jsonObject;
    }

    public <T extends AbstractBaseVO> T fromJson(String jsonData, Class clazz) throws IOException {
        return (T) objectMapper.readValue(jsonData, clazz);
    }

    public String toJson(AbstractBaseVO registo) throws JsonProcessingException {
